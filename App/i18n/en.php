...
return [
    // Flash
    "flash/danger/activation" => "<b>Danger!</b> Activation cannot be completed. Invalid username or hash.",
    'flash/danger/forbidden' => "<b>Danger!</b> You don't have access to this page.",
    "flash/notice/activation" => "<b>Notice!</b> Activation has already been completed.",
    "flash/notice/checkEmail" => "<b>Notice!</b> Check Email to activate your account.",
    "flash/success/activation" => "<b>Success!</b> Activation completed. Please log in.",
    "flash/success/contact" => "<b>Success!</b> Message was sent",
